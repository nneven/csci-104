 ...
 * @return
 */
testing::AssertionResult checkConsoleOutput(std::string const & inputFile, std::string const & inputDatabase, std::vector<ConsoleParserCommand> commandTypes, std::string const & expectedConsoleOutput, bool useValgrind = true, bool checkRecOrder = false);
